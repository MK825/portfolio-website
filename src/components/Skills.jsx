...
import {
  ...
  FaLinux,
  FaFigma,
  FaAws, FaAngular, FaVuejs, FaHardHat,
} from "react-icons/fa";
import {
  SiNextdotjs,
  SiTypescript,
  ...
  SiFirebase,
  SiVercel,
  SiVite, SiSolidity, SiWeb3Dotjs, SiEthers, SiWalletconnect,
} from "react-icons/si";
  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "Angular", icon: <FaAngular className="w-4 h-4 text-[#C21325]" /> },
        { name: "Vue.js", icon: <FaVuejs className="w-4 h-4 text-[#339933]" /> },
      ],
    },
    {
      icon: Database,
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "Web3.js",
          icon: <SiWeb3Dotjs className="w-4 h-4 text-[#9CA3AF]" />,
        },
        {
          name: "Ethers.js",
        ...
        },
        {
          ...
          icon: <SiWalletconnect className="w-4 h-4 text-[#FF6C37]" />,
        },
      ],
    },
    {
