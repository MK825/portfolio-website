...
const ExperienceSection = () => {
  const experiences = [
    ...
    },
    {
      ...
      period: "2017 - 2020",
      description:
        "Developed user-friendly web applications using React.js and Angular, improving customer satisfaction scores by 18%.\n",
    },
    {
      icon: Code2,
      ...
      period: "2020 - Present",
      description:
        "Built responsive user interfaces for decentralized applications (dApps) using React.js, Next.js, and React Native, increasing user retention by 20%.",
    },
  ];
