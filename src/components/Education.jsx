  ...
  const educationData = [
    {
      ...
      school: "North Florida College",
      mascot: "📘",
      year: "2007-2011",
      achievements: ["GPA: 3.65", "Subject: Information Technology"],
    ...
    },
    {
      ...
      mascot: "📗",
      year: "2011-2015",
      achievements: ["GPA: 3.87", "Subject: Computer Science"],
      skills: ["Software Development", "Data Management", "Algorithm Design"],
      description:
